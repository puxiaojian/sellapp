...
<script type="text/ecmascript-6">
  ...
  import {sevaToLocal, loadFromLocal} from '../../common/js/store';
    ...
    methods: {
      ...
      _initPics() {
        if (this.seller.pics) {
          ...
          this.$nextTick(() => {
            if (!this.picScroll) {
              this.picScroll = new BScroll(this.$refs.piclist.parentNode, {
                scrollX: true,
      ...
      toggleFavorite(event) {
        ...
        sevaToLocal(this.seller.id, 'favorite', this.favorite);
      }
    },
    components: {
      star,
